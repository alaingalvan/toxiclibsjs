 ...
 */
class DelaunayTriangulation extends AbstractSet<DelaunayTriangle> {

    DelaunayTriangle mostRecent = null;

    UndirectedGraph<DelaunayTriangle> triGraph;
     ...
     */
    DelaunayTriangulation(DelaunayTriangle triangle) {
     ...
     */
    boolean contains(Object triangle) {
     ...
     */
    Set<DelaunayTriangle> getCavity(DelaunayVertex site,
    ...
    @Override
    Iterator<DelaunayTriangle> iterator() {
     ...
     */
    DelaunayTriangle locate(DelaunayVertex point) {
     ...
     */
    DelaunayTriangle neighborOpposite(DelaunayVertex site,
            DelaunayTriangle triangle) {
        if (!triangle.contains(site)) {
     ...
     */
    Set<DelaunayTriangle> neighbors(DelaunayTriangle triangle) {
     ...
     */
    List<DelaunayTriangle> surroundingTriangles(DelaunayVertex site,
            DelaunayTriangle triangle) {
        if (!triangle.contains(site)) {
     ...
     */
    DelaunayTriangle update(DelaunayVertex site,
